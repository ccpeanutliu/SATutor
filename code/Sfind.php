...
if ($_GET['find-region']) {
  $sql = "SELECT * FROM T_case_table WHERE Region = '".$_GET['find-region']."'";
}
elseif ($_GET['find-subject']) {
  $sql = "SELECT * FROM T_case_table WHERE Subject = '".$_GET['find-subject']."'";
}
elseif ($_GET['find-subject'] && $_GET['find-region']) {
  $sql = "SELECT * FROM T_case_table WHERE Subject = '".$_GET['find-subject']."' AND Region = '".$_GET['find-region']."'";
}
else {
